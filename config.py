...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1002052427314"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/chintu704203/SWEETY-MUSIC",
)
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/5787fdd255eaefa68c9e5.jpg"
)
PING_IMG_URL = getenv(
